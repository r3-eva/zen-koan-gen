...
const zenLast = ['Qigang Nakayama', 'Hirokumi Kojima', 'Iwao Murata', 'Masashi Sumisu', 'Jotaro Zhan', 'AKio Okita', 'Kamatari Sakata', 'Bunrakuken Kanbayashi', 'Shinichi Okimoto', 'Sekien Miyashita'];
